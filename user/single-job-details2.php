...
if (isset($_POST['mail'])) {
 extract($_POST);
  ...
  echo$email="renukakamath2@gmail.com";
...
if(!$mail->Send())
{
  ...
  alert("mail not  send");
  window.location="jobs-listed2.php";
  </script>
...
<!-- <a href="?mail" class="aply-btn ">Appy Now</a> -->
<form method="post">

<button name="https://mail.google.com/mail/u/0/#inbox">Appy Now</button>
                                                <?php } else { ?>
