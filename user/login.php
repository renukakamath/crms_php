...
if(isset($_POST['login']))
 ...
 -->
  ...
  if (isset($_POST['login'])) {
      ...
      echo$q="select * from tbluser where username='$emailcont' and Password='$password'";
      $res=select($q);
 ...
 return redirect('/crms/user/dashboard.php');
...
<head>
    ...
    <title>August Research || Quantitative & Qualitataive Research || Login Page</title>
    <!-- CSS -->
